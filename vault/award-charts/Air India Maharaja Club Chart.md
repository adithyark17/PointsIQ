...
> Post-merger program still stabilising; domestic levels observed, international semi-dynamic.

## Pricing

| Route | Economy | Business | First |
|---|---|---|---|
| Domestic short (e.g. DEL→BOM) ([[DEL]], [[BOM]]) | 8,000 | 20,000 | — |
| Domestic long (e.g. DEL→BLR/MAA) ([[DEL]], [[BLR]]) | 10,000 | 25,000 | — |
| India → Gulf ([[BOM]], [[DXB]]) | 15,000 | 35,000 | — |
